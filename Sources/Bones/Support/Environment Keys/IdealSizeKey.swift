...
public extension EnvironmentValues {
  ...
  /// The expanding behaviour of compatible Bones components in a view relative to their ideal size.
...
public extension View {
  ...
  /// Sets the expanding behaviour of compatible Bones components in a view relative to their ideal size in specified direction.
  ///
  ...
  /// Prevents compatible Bones components in a view from additionally expanding beyond its ideal size in both axis.
  ///
